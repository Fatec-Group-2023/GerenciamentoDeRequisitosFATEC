...
<body>
    ...
    <div class="container-fluid no-border custom-padding text-center">
        <div class="row justify-content-center"> <!-- Adicionado justify-content-center -->
            ...
            <div class="col-md-3 col-sm-3">
                <a href="#">
                    <button class="button"><img src="../../img/open-exit-door.png" alt="Salas e Maquinas"><br>
                        <br>Solicitar Nova Sala</button>
                </a>
            </div>
        </div>
    </div>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/Jm